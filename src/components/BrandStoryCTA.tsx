  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 brand-story-bg">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-gray-900/80 via-gray-800/60 to-gray-900/80" />
      </div>
      ...
      <div className="container-custom relative z-10">
        ...
        >
          ...
          >
            {[
              { number: '500+', label: 'Items Restored' },
              ...
              >
                <div className="font-copperplate text-3xl md:text-4xl font-bold text-fawn mb-2">
                  {stat.number}
                </div>
